...
[![My Skills](https://skillicons.dev/icons?i=html,css,bootstrap,tailwind,js,ts,alpinejs,php,java,react,nodejs,express,laravel,redis,postgresql,mysql,mongodb,python,docker,bash)](https://skillicons.dev)
